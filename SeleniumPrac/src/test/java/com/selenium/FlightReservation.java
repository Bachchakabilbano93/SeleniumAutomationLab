...
public class FlightReservation {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(1000);
		driver.findElement(By.xpath("//*[@aria-label='07/07/2022']")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("//*[@class='btn btn-danger  mt-0 btn-block bgshade-2 btn-lg font-weight-bold']")).click();
